...
inline int orient_yz_lle(const implicitPoint3D_LPI& a, const implicitPoint3D_LPI& b, const explicitPoint3D& c) {
    ...
    a.getExactLambda(l1x, l1x_len, l1y, l1y_len, l1z, l1z_len, d1, d1_len);
    b.getExactLambda(l2x, l2x_len, l2y, l2y_len, l2z, l2z_len, d2, d2_len);
    return orient_xy_iie_exact(l1y, l1y_len, l1z, l1z_len, d1, d1_len, l2y, l2y_len, l2z, l2z_len, d2, d2_len, c.ptr() + 1);
}
...
inline int orient_zx_lle(const implicitPoint3D_LPI& a, const implicitPoint3D_LPI& b, const explicitPoint3D& c) {
    ...
    if (!a.getIntervalLambda() || !b.getIntervalLambda()) return 0;
    if ((ret = orient_xy_iie_interval(a.dfilter[2], a.dfilter[0], a.dfilter[3], b.dfilter[2], b.dfilter[0], b.dfilter[3], c.z, c.x)) != 0.0) return ret;
